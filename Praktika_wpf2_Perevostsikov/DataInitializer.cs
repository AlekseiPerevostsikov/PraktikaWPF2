    ...
    class DataInitializer : DropCreateDatabaseAlways<Context>
    {
        ...
        protected override void Seed(Context context)
        {
            ...
            var student = new List<Student>
            {
                ...
                new Student{FirstName="Pavel", LastName="Petrov", Isikukood="31547895214", SchoolName="Astangu", ClassNumber="9A", Phone="+37254789584", Adress="Narva", GroupId=7},
                ...
                new Student{FirstName="Aleksandr", LastName="Smirnov", Isikukood="34578952147", SchoolName="Vana", ClassNumber="1A", Phone="", Adress="Narva", GroupId=8},
